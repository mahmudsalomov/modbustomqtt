...
public class CommPortIdentifier {
    ...
    static {
        try {
            CommDriver RXTXDriver = (CommDriver) Class.forName("RXTXCommDriver").newInstance();
            RXTXDriver.initialize();
        } catch (Throwable e) {
            System.err.println(e + " thrown while loading " + "RXTXCommDriver");
        }
    ...
    static public Enumeration<CommPortIdentifier> getPortIdentifiers() {
        ...
        synchronized (Sync) {
            ...
            try {
                ...
                //{@link #addPortName(java.lang.String, int, CommDriver)}
     ...
     * @throws PortInUseException when the exclusive ownership of the
